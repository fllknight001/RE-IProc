const testimonials = [
  { name: 'Gilang Ramadhan', position: 'S.T., MBA., CPSLOG., CRMO', content: 'Penerapan aplikasi iProc merupakan bagian dari strategi WIKA dalam mengimplementasikan konsep Procurement 4.0. Aplikasi iProc berhasil <strong> mempercepat proses pengadaan hingga 62% </strong> , menghasilkan <strong> penghematan sebesar 273 miliar dalam tiga tahun,</strong>, serta meningkatkan produktivitas organisasi pengadaan (lean organization) dalam mengelola pengadaan dan kontrak senilai Rp 6,4 triliun dengan hanya 14 personel.' },
